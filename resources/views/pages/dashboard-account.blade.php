    ...
    <div class="section-content section-dashboard-home" data-aos="fade-up">
        <div class="container-fluid">
            <div class="dashboard-heading">
                ...
                <p class="dashboard-subtitile">Update your current profile</p>
            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-control" id="addressTwo" name="addressTwo"
                                                    value="{{ $user->email }}" />
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="regencies_id" id="regencies_id" class="form-control"
                                                    v-if="provinces" v-model="regencies_id">
