    ...
    <div class="page-content page-cart">
        ...
        <section class="store-cart">
            <div class="container">
                                ...
                                @foreach ($carts as $cart)
                                    <tr>
                                        ...
                                        <td style="width: 35%">
                                            ...
                                            <div class="product-subtitle">{{ $cart->product->store_name }}</div>
                                        </td>
                                        <td style="width: 35%">
                ...
                <form action="{{ route('checkput') }}" method="POST" enctype="multipart/form-data" id="locations">
                    @csrf
                    ...
                    <div class="row mb-2" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="provinces_id">Province To</label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="regencies_id" id="regencies_id" class="form-control" v-if="provinces"
